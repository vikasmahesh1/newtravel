...
export default function LoginPage() {
  ...
  usePageMetadata({
    title: 'Sign in to VyuGo Holidays',
    description: 'Access your VyuGo Holidays bookings, loyalty perks, and saved journeys by signing in.',
    keywords: 'VyuGo login, travel account login',
    canonicalPath: '/login',
  })
