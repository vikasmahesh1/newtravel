  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-12">
      <header className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        ...
        {profile && (
          <div className="rounded-3xl bg-primary/10 px-5 py-3 text-sm font-semibold text-primary">
            {profile.tier}
          </div>
        )}
      </header>
      {!profile && (
        <div className="mt-8 rounded-3xl bg-white p-6 text-sm text-slate-600 shadow-card">
          Sign in to sync saved searches, manage traveler profiles, and view loyalty activity in real time.
        </div>
      )}
