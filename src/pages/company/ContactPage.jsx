...
export default function ContactPage() {
  usePageMetadata({
    title: 'Contact VyuGo Holidays | Kakinada HQ & Hyderabad lounge',
    description:
      'Reach VyuGo Holidays concierge desks in Kakinada and Hyderabad for curated itineraries, corporate travel, and support.',
    keywords: 'Contact VyuGo Holidays, Kakinada travel agency contact, Hyderabad travel support',
